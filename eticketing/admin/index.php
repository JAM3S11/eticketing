                        ...
                        <div id="userConfirmT" style="width: 100%;">
                            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                                ...
                                <form class="userConfirm" name="userConfirm">
                                    <input type="text" style="display: none;" class="userid" name="userid"
                        ...
                        <div id="userEditT" style="width: 100%;">
                            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                                ...
                                <form class="userEdit" name="userEdit">
                                    ...
                                    <td><?php echo $user['name']; ?></td>
                                    <td>
                                        <select required class="usertype" name="usertype"
                                            style=" padding: 5px 10px; border: none; background-color: #333; color: #fff; cursor: pointer;">
                                            <option value="" disabled selected>Select User Type</option>
                                            <option value="Admin"> Admin</option>
                                            <option value="Service Desk"> Service Desk</option>
                                    ...
                                    <td>
                                        <select required class="aos" name="aos"
                                            style=" padding: 5px 10px; border: none; background-color: #333; color: #fff; cursor: pointer;">
                                ...
                                <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                                    ...
                                    ?>
                                            <form class="assignT" name="assignT">
                                                <input type="text" style="display: none;" class="issue" name="issue"
                                                    value=<?php echo $complaint['ComplaintId']; ?>>
                                                <input type="text" style="display: none;" class="userid" name="userid"
                                                    value=<?php echo $uid; ?>>
                                                <select class="expert" name="expert"
                                                    style=" padding: 5px 10px; border: none; background-color: #333; color: #fff; cursor: pointer;"
                                                    required>
                                                    <option value="" disabled selected>Select Officer</option>
                                                    <?php foreach ($officers as $officer) {  
                                                ?>
                                                    <option value="<?php echo $officer['UserId']; ?>">
                                                        <?php echo $officer['Name']; ?> </option>
                                                    <?php  } ?>
                                                </select>
                                                <button
                                                    style=" padding: 5px 10px; margin-left: 20px; border: none; background-color: #333; color: #fff; cursor: pointer;"
                                                    type="submit" name="submit">Assign</button>
                                    ...
                                    <tr class="clickable-row"
                                        ...
                                        ?>
                                            ...
                                            <form class="transferT" name="transferT">
                                                ...
                                                <button
                                                    style=" padding: 5px 10px; border: none; margin-left: 20px; background-color: #333; color: #fff; cursor: pointer;"
                                                    type="submit" name="submit">Transfer</button>
                                            </form>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
